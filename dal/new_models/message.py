...
class MessageValue(BaseModel):
    """A class the represent the MessageValue field."""
...
class Message(MovaiBaseModel):
    ...
    @classmethod
    def get_msgs(cls, package: str, msg_type: str = "all", db: str = "global") -> List:
        ...
        if msg_type in ("msg", "all"):
            try:
                ...
                try:
                    ...
                    # package not found
                    cls._logger.warning("package not found")
                    pass
        if msg_type in ("srv", "all"):
            try:
        ...
        if msg_type == "action":
            try:
                ...
                try:
                    ...
                    # not found
                    cls._logger.warning("KeyError after rospkg.common.ResourceNotFound")
                    pass
    ...
    def get_all(db="global") -> Dict[str, List]:
        ...
        db_packs: List[str] = [msg_name for msg_name in Message.get_model_names(db=db)]
