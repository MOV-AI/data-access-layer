...
from movai.core.vault import (JWT_ACCESS_EXPIRATION_DELTA,
...
class User(Scope):
    ...
    def verify_password(self, provided_password):
        ...
        pwdhash = hashlib.pbkdf2_hmac('sha256', provided_password.encode(
    ...
    def create_id(self):
        ...
        user_id = json.loads(
            json.dumps(
                self.get_dict()[self.scope][self.name]
            ))
    ...
    @classmethod
    def reset(cls, *, username: str, current_pass: str = None, new_pass: str, confirm_pass: str, validate_current_pass: bool = True) -> bool:
        """ Reset user password
